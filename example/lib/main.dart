        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // ==========================================
              Center(
                child: FormFieldAdapter<String?>(
                  initialValue: _avatarUrl,
                  focusNode: _avatarFocusNode,
                  validator: (value) => value == null ? 'Profile picture is required' : null,
                  onSaved: (value) => _avatarUrl = value,
                  // We can pass circular custom decorations.
                  // Because standard border outline cannot be used on a CircleAvatar,
                  // our custom decorations shine here!
                  normalDecoration: const BoxDecoration(
                    shape: BoxShape.circle,
                    border: Border.fromBorderSide(BorderSide(color: Colors.transparent, width: 3)),
                  ),
                    ...
                    return Focus(
                      ...
                      child: GestureDetector(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: state.value != null ? NetworkImage(state.value!) : null,
              ...
              // ==========================================
              Text('How would you rate your Flutter experience?', style: theme.textTheme.titleMedium),
              ...
              FormFieldAdapter<int>(
                ...
                validator: (value) {
                  ...
                  if (value < 3) return 'Must be at least a 3-star rating to join';
                  return null;
                },
                onSaved: (value) => _rating = value ?? 0,
                // Default underline styling is generated automatically,
                // but we can completely override the border layout behavior:
              ...
              // ==========================================
              Text('Select your preferred languages (at least 2):', style: theme.textTheme.titleMedium),
              const SizedBox(height: 8),
              FormFieldAdapter<List<String>>(
                ...
                builder: (state) {
                  ...
                  final options = ['Dart', 'Kotlin', 'Swift', 'TypeScript', 'Go', 'Python'];
                        ...
                        children: options.map((option) {
                          ...
                          return FilterChip(
                            ...
                            onSelected: (bool selected) {
                              ...
                              final newList = List<String>.from(currentSkills);
                              if (selected) {
                                newList.add(option);
                              } else {
              ...
              FormFieldAdapter<bool>(
                ...
                validator: (value) => value == true ? null : 'You must accept the terms to proceed',
                ...
                builder: (state) {
                  return Card(
                    color: state.hasError ? theme.colorScheme.errorContainer.withValues(alpha: .3) : null,
                    child: Padding(
              ...
              ElevatedButton(
                ...
                child: const Text('Register Profile', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ),
